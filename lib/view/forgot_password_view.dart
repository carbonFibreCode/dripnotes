...
import 'package:dripnotes/utilities/dialog/password_reset_email_sent_dialog.dart';
import 'package:dripnotes/utilities/dialog/show_error_dialog.dart';
          ...
          body: Padding(
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  const Text(
                      'if you forgot your password, please enter your registered email'),
                  TextField(
